...
if dataset == 'sysu':
    data_path = '/root/Downloads/hetero/datasets/SYSU/'
    log_path = args.log_path + 'sysu_log/'
    n_class = 395
    test_mode = [1, 2] 
elif dataset =='regdb':
    data_path = '/root/Downloads/hetero/datasets/RegDB/'
...
if dataset =='regdb':
    ...
    for trial in range(10):
        ...
        gall_feat = Normalize(gall_feat)
        distmat = np.matmul(query_feat, np.transpose(gall_feat))
        cmc, mAP = eval_sysu(query_img, gall_img, 1-distmat, query_label, gall_label,query_cam, gall_cam)
